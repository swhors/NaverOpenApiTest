...
class RecyclerViewTrendAdapter(_sqLiteCtl: SQLiteCtl): RecyclerView.Adapter<RecyclerViewTrendAdapter.ItemHolder>() {
    ...
    class ItemHolder(parent: ViewGroup, _sqLiteCtl: SQLiteCtl, _adapter: Any):RecyclerView.ViewHolder(
        ...
        private var adapter = _adapter as RecyclerViewTrendAdapter
